...
namespace DataLogger
{
    public partial class frmNewMain : Form
    {
        ...
        public void serialPortSAMP_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                if (!serialPortSAMP.IsOpen)
                ...
                */
                ...
                else SAMP_rx_buffer = SAMP_rx_buffer.Concat(buffer).ToArray();
                SAMP_rx_counter += bytes;
                if (SAMP_rx_buffer != null)
                {
        ...
        private void serialPortADAM_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                //string raw_data2 = Encoding.UTF8.GetString(new_data);
                //Console.WriteLine("Leng: " + new_data.Length);
                //Console.WriteLine("data : " + Encoding.UTF8.GetString(new_data));
                ProcessDataADAM("");
                    ...
                    if (text.Length >= ADAM_TEMP_HUMIDITY_PACKET_LENGTH)
                    {
                        for (int i = 0; i < text.Length - ADAM_TEMP_HUMIDITY_PACKET_LENGTH; i++)
                        {
                                ...
                                )
                            {
                                ...
                                //string raw_data2 = Encoding.UTF8.GetString(text);
                                //Console.WriteLine("ADAM405x_rx_counter : " + ADAM405x_rx_counter);
                                //Console.WriteLine("data : " + raw_data2.Trim().Length + " : ");
                                //Console.WriteLine(raw_data2.Trim());
                                ...
                                foreach (module itemModule in ADAM4017Modules)
                                {
                                    ...
                                    switch (itemModule.item_name.ToLower().Trim())
                                    {
                                        ...
                                        case "temp":
                                            ...
                                            //Console.Write("do --- " + str_input[indexTemp] + "\n");
                    ...
                    if (db.open_connection())
                    {
                        ...
                        using (NpgsqlCommand cmd = db._conn.CreateCommand())
                        {
                            ...
                            foreach (DataRow row2 in tbcode.Rows)
                            {
                                ...
                                {
                                    case "ph":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "ec":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_EC)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "do":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_DO)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "tss":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_Turbidity)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "orp":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_ORP)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "temp":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.MPS_Temp)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                    ...
                                    case "turbi":
                                        ...
                                        break;
                                    case "tn":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.TN)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "tp":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.TP)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
                                        ...
                                        break;
                                    case "toc":
                                        if (Convert.ToDouble(String.Format("{0:0.00}", data.TOC)) >= min_value && Convert.ToDouble(String.Format("{0:0.00}", data.MPS_pH)) != -1)
                                        {
                                        }
                                        else
                                        {
        ...
        private void updateCellSamplerStatus(water_sampler obj)
        {
            try
            {
                ...
                else if (obj.equipment_status == INT_STATUS_MEASURING_STOP) //sampling
                {
                    tooltipSAMP = "run";
